...
//			  int socketNumToServer,
//			  MediaTranscodingTable* transcodingTable,
//			  createNewMyRTSPClientFunc* ourCreateNewProxyRTSPClientFunc,
//			  portNumBits initialPortNum, Boolean multiplexRTCPWithRTP)
...
//    fPresentationTimeSessionNormalizer(new MyPresentationTimeSessionNormalizer(envir())),
...
//				       socketNumToServer);
//  ьнRTSPClient::sendDESCRIBE(fProxyRTSPClient);
//}
//
//MyServerMediaSession::~MyServerMediaSession() {
...
//}
//
//ProxyRTSPClient::ProxyRTSPClient(MyServerMediaSession& ourServerMediaSession, char const* rtspURL,
//				 char const* username, char const* password,
//				 portNumBits tunnelOverHTTPPortNum, int verbosityLevel, int socketNumToServer)
